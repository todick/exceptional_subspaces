...
if __name__ == "__main__":
    ...
    os.makedirs(f"results/RQ1/{args.method}/scalability_features/{args.dataset}/{args.casestudy}", exist_ok=True)
    result_path = f"results/RQ1/{args.method}/scalability_features/{args.dataset}/{args.casestudy}/{args.seed}.csv"
